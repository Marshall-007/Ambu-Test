            ...
            public void onClick(View v) {
                switch(status){
                    case 1:
                        ...
                        mRideStatus.setText("Paciant safe");
        ...
        assignedCustomerPickupLocationRefListener = assignedCustomerPickupLocationRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists() && !customerId.equals("")){
                    ...
                    pickupMarker = mMap.addMarker(new MarkerOptions().position(pickupLatLng).title("Paciant Location"));
...
// When the driver has reached his destination
    private void endRide(){
        //Will Have to change Picked Customer to something better
...
// In this function we record the users ride
